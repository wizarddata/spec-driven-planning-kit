...
| `PLAN.md` "Kit conventions" header | Auto-loaded with PLAN.md per feature | Operational rules (sweep-vs-bend matrix, commit format, promote-and-reset) — kit bakes them in. |
